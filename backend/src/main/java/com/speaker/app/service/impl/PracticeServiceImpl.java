...
import com.speaker.app.repository.ConversationTurnMapper;
import com.speaker.app.repository.PracticeSessionMapper;
import com.speaker.app.repository.QuestionBankItemMapper;
import com.speaker.app.repository.SessionReportMapper;
import com.speaker.app.model.entity.*;
import com.speaker.app.service.intf.CurrentUserServiceIntf;
import com.speaker.app.service.intf.PracticeServiceIntf;
import com.speaker.app.service.intf.QwenServiceIntf;
...
@Service
public class PracticeServiceImpl implements PracticeServiceIntf {
    ...
    private final QwenServiceIntf qwenService;
    ...
    public PracticeServiceImpl(
            ...
            CurrentUserServiceIntf currentUserService,
    ...
    private QuestionBankItem resolveBankItem(String season, PracticeSession.Part part, Long bankQuestionId) {
        ...
        QuestionBankItem picked =
                part == PracticeSession.Part.PART2_AND_3
                        ? bankMapper.findRandomOneBySeasonPart2Or3(season)
                        : bankMapper.findRandomOneBySeasonAndPart(season, part.name());
        if (picked == null) {
