...
public class PracticeController {
    ...
    private final PracticeServiceIntf practiceService;

    public PracticeController(PracticeServiceIntf practiceService) {
    ...
    public PracticeServiceIntf.SessionDetailDto detail(@PathVariable("id") long id) {
