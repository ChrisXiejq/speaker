...
public class PracticeSpeechController {
    ...
    private final DashScopeSpeechServiceIntf dashScopeSpeechService;
    private final AppProperties appProperties;

    public PracticeSpeechController(DashScopeSpeechServiceIntf dashScopeSpeechService, AppProperties appProperties) {
